...
#define STRING_CONFIG_H_AUTHOR "(Rares, Ender-5 Plus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-5P"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 169.72
  #define DEFAULT_bedKi 27.19
  #define DEFAULT_bedKd 706.04
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -5.5, 0 }
...
#define HOMING_FEEDRATE_MM_M { (200*60), (200*60), (4*60) }
